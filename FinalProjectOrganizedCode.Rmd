...
agnosticTimeLineGroupedOneDose <- group_by(agnosticTimeLine, Date, betterAgeGroup) %>% summarise(`Percent of age group with at least one dose` = sum(`Percent of age group with at least one dose`))
agnosticTimeLineGroupedFully <- group_by(agnosticTimeLine, Date, betterAgeGroup) %>% summarise(`Percent of age group fully vaccinated` = sum(`Percent of age group fully vaccinated`))
agnosticTimeLineGroupedAll <- left_join(agnosticTimeLineGroupedOneDose, agnosticTimeLineGroupedFully)

agnosticTimeLineGroupedOneDose_Total <- group_by(agnosticTimeLineGroupedOneDose, Date) %>% summarise(`Percent of age group with at least one dose` = sum(`Percent of age group with at least one dose`))
agnosticTimeLineGroupedFully_Total <- group_by(agnosticTimeLineGroupedFully, Date) %>% summarise(`Percent of age group fully vaccinated` = sum(`Percent of age group fully vaccinated`))
