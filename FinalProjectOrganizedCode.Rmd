...
colnames(johnsonTimeline) <- c("State", "Week", "FirstDoseAllocation")
...
pfizerTimeline <- left_join(stateInfo, pfizerTimeline, by = c("google_name" = "State"))
modernaTimeline <- left_join(stateInfo, modernaTimeline, by = c("google_name" = "State"))
johnsonTimeline <- left_join(stateInfo, johnsonTimeline, by = c("google_name" = "State"))
